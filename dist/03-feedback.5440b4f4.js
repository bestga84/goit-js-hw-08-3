...
const fillContactFormFields = ()=>{
    ...
    if (contactFormDataFrom === undefined) return;
    userData = {
        ...contactFormDataFrom
    };
    for(const prop in contactFormDataFrom)if (contactFormDataFrom.hasOwnProperty(prop)) feedbackFormEl.elements[prop].value = contactFormDataFrom[prop];
};
...
feedbackFormEl.addEventListener("input", (0, _lodashThrottleDefault.default)(onFormFieldChange, 500));
